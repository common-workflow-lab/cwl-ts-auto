...
export class CommandOutputRecordField extends Saveable implements Internal.CommandOutputRecordFieldProperties {
   ...
   * 
   */
  type: Internal.CWLType | Internal.CommandOutputRecordSchema | Internal.CommandOutputEnumSchema | Internal.CommandOutputArraySchema | string | Array<Internal.CWLType | Internal.CommandOutputRecordSchema | Internal.CommandOutputEnumSchema | Internal.CommandOutputArraySchema | string>
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    let type
    try {
      type = await loadField(_doc.type, LoaderInstances.,
        baseuri, loadingOptions)
    } catch (e) {
      if (e instanceof ValidationException) {
        __errors.push(
  ...
  : Dictionary<any> {
    ...
    if (this.outputBinding != null) {
      r.outputBinding = save(this.outputBinding, false, this.name, relativeUris)
    }
  ...
  static attr: Set<string> = new Set(['doc','name','type','label','secondaryFiles','streamable','format','outputBinding'])
}
