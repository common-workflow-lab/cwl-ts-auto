...
export class InputArraySchema extends Saveable implements Internal.ArraySchema, Internal.InputSchema {
  ...
  constructor ({extensionFields, loadingOptions, name, items, type, label, doc} : {extensionFields?: Dictionary<any>, loadingOptions?: LoadingOptions,  items: string | Internal.InputRecordSchema | Internal.InputEnumSchema | Internal.InputArraySchema | Array<string | Internal.InputRecordSchema | Internal.InputEnumSchema | Internal.InputArraySchema>, type: string, label: undefined | string, doc: undefined | string | Array<string>, name: undefined | string,}) {
    super()
