...
export class CommandInputRecordField extends Saveable implements Internal.InputRecordField, Internal.CommandLineBindable {
  ...
  constructor ({extensionFields, loadingOptions, name, doc, type, label, secondaryFiles, streamable, format, loadContents, loadListing, inputBinding} : {extensionFields?: Dictionary<any>, loadingOptions?: LoadingOptions,  doc: undefined | string | Array<string>, name: string, type: string | Internal.CommandInputRecordSchema | Internal.CommandInputEnumSchema | Internal.CommandInputArraySchema | Array<string | Internal.CommandInputRecordSchema | Internal.CommandInputEnumSchema | Internal.CommandInputArraySchema>, label: undefined | string, secondaryFiles: undefined | Internal.SecondaryFileSchema | Array<Internal.SecondaryFileSchema>, streamable: undefined | boolean, format: undefined | string | Array<string>, loadContents: undefined | boolean, loadListing: undefined | string, inputBinding: undefined | Internal.CommandLineBinding,}) {
    super()
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    if (errors.length > 0) {
      throw new ValidationException("Trying 'CommandInputRecordField'", errors)
    }
