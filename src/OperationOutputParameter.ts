 ...
 * 
 */
export class OperationOutputParameter extends Saveable implements Internal.OperationOutputParameterProperties {
  ...
  constructor ({loadingOptions, extensionFields, id, label, secondaryFiles, streamable, doc, format, type} : {loadingOptions?: LoadingOptions} & Internal.OperationOutputParameterProperties) {
