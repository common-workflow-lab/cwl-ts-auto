...
export class CommandOutputParameter extends Saveable implements Internal.CommandOutputParameterProperties {
   ...
   * 
   */
  type: Internal.CWLType | Internal.stdout | Internal.stderr | Internal.CommandOutputRecordSchema | Internal.CommandOutputEnumSchema | Internal.CommandOutputArraySchema | string | Array<Internal.CWLType | Internal.CommandOutputRecordSchema | Internal.CommandOutputEnumSchema | Internal.CommandOutputArraySchema | string>
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    let type
    try {
      type = await loadField(_doc.type, LoaderInstances.,
        baseuri, loadingOptions)
    } catch (e) {
      if (e instanceof ValidationException) {
        __errors.push(
    ...
    if ('outputBinding' in _doc) {
      try {
        outputBinding = await loadField(_doc.outputBinding, LoaderInstances.unionOfundefinedtypeOrCommandOutputBindingLoader,
          baseuri, loadingOptions)
      } catch (e) {
        if (e instanceof ValidationException) {
          __errors.push(
  ...
  : Dictionary<any> {
    ...
    if (this.outputBinding != null) {
      r.outputBinding = save(this.outputBinding, false, this.id, relativeUris)
    }
  ...
  static attr: Set<string> = new Set(['label','secondaryFiles','streamable','doc','id','format','type','outputBinding'])
}
