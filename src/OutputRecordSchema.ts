 ...
 */
export class OutputRecordSchema extends Saveable implements Internal.OutputRecordSchemaProperties {
  ...
  constructor ({loadingOptions, extensionFields, name, fields, type, label, doc} : {loadingOptions?: LoadingOptions} & Internal.OutputRecordSchemaProperties) {
