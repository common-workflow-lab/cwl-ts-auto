 ...
 */
export class CommandOutputEnumSchema extends Saveable implements Internal.CommandOutputEnumSchemaProperties {
  ...
  constructor ({loadingOptions, extensionFields, name, symbols, type, label, doc} : {loadingOptions?: LoadingOptions} & Internal.CommandOutputEnumSchemaProperties) {
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    if (__errors.length > 0) {
      throw new ValidationException("Trying 'CommandOutputEnumSchema'", __errors)
    }
