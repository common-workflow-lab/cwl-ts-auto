...
export async function loadDocument (doc: any, baseuri?: string, loadingOptions?: LoadingOptions): Promise<Internal.SimpleSchema | Internal.SimpleSchema[]> {
  if (baseuri == null) {
  ...
  return await documentLoad(LoaderInstances.unionOfSimpleSchemaLoaderOrarrayOfunionOfSimpleSchemaLoader, doc, baseuri, loadingOptions)
}

export async function loadDocumentByString (doc: string, uri: string, loadingOptions?: LoadingOptions): Promise<Internal.SimpleSchema | Internal.SimpleSchema[]> {
  ...
  return await documentLoad(LoaderInstances.unionOfSimpleSchemaLoaderOrarrayOfunionOfSimpleSchemaLoader, result, uri, loadingOptions)
}
