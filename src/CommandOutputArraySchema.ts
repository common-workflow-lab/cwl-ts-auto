 ...
 */
export class CommandOutputArraySchema extends Saveable implements Internal.CommandOutputArraySchemaProperties {
  ...
  constructor ({loadingOptions, extensionFields, name, items, type, label, doc} : {loadingOptions?: LoadingOptions} & Internal.CommandOutputArraySchemaProperties) {
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    if (__errors.length > 0) {
      throw new ValidationException("Trying 'CommandOutputArraySchema'", __errors)
    }
