 ...
 */
export class OutputRecordSchema extends Saveable implements Internal.RecordSchema, Internal.OutputSchema {
  ...
  constructor ({extensionFields, loadingOptions, name, fields, type, label, doc} : {extensionFields?: Dictionary<any>, loadingOptions?: LoadingOptions,  fields: undefined | Array<Internal.OutputRecordField>, type: string, label: undefined | string, doc: undefined | string | Array<string>, name: undefined | string,}) {
    super()
  ...
  static override async fromDoc (__doc: any, baseuri: string, loadingOptions: LoadingOptions,
    ...
    if ('fields' in _doc) {
      try {
        fields = await loadField(_doc.fields, LoaderInstances.idmapfieldsunionOfundefinedtypeOrarrayOfOutputRecordFieldLoader,
          baseuri, loadingOptions)
      } catch (e) {
        if (e instanceof ValidationException) {
          __errors.push(
    ...
    if (__errors.length > 0) {
      throw new ValidationException("Trying 'OutputRecordSchema'", __errors)
    }
